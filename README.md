...
**Platform:** macOS (MacBook Air), Web <br> 
**Engine:** Unity + FMOD
...
*   **Visual Guidance System:** A "Ghost Pen" tutorial using integrated **Trail Renderers** to guide first-time users through the interface.
...
To turn on/off camera shake, press F.
